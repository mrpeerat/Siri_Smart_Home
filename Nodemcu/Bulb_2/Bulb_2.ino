...
void loop() 
{
    ...
    {   
            ...
            if(line == "Bulb/2/true"){
              ...
              digitalWrite(13, LOW);
              client.println("Thing_Bulb/2/Confirm-true");
            }
            else if(line == "Bulb/2/false" ){
              Serial.print("Bulb 2 is off!\n");
              digitalWrite(13, HIGH);
              client.println("Thing_Bulb/2/Confirm-false");
            }else if (line == "reset"){
              Serial.print("Bulb 2 is Reset!\n");
              digitalWrite(13, HIGH);
              client.println("Thing_Bulb/2/Confirm-reset");
              delay(1500);
            }
