...
void loop() 
{
    ...
    {   
            ...
            if(line == "Plug/2/true"){
              ...
              digitalWrite(13, LOW);
              client.println("Thing_Plug/2/Confirm-true");
            }
            else if(line == "Plug/2/false" ){
              Serial.print("Plug 2 is off!\n");
              digitalWrite(13, HIGH);
              client.println("Thing_Plug/2/Confirm-false");
            } else if (line == "reset"){
              Serial.print("Plug 2 is Reset!\n");
              digitalWrite(13, HIGH);
              client.println("Thing_Plug/2/Confirm-reset");
            }
