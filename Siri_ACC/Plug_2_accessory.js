...
client.on('connect', function () {
  client.subscribe('Thing_Plug/2/Confirm')
...
var outletUUID = uuid.generate('hap-nodejs:accessories:Plug_2');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var outlet = exports.accessory = new Accessory('Plug_2', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "1B:2E:3F:4E:5T:6F";
...
outlet
  ...
  .setCharacteristic(Characteristic.SerialNumber, "A1");
...
outlet
  .addService(Service.Outlet, "Plug_2") // services exposed to the user should have "names" like "Fake Light" for us
  .getCharacteristic(Characteristic.On)
