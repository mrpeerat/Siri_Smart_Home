...
client.on('connect', function () {
  client.subscribe('Thing_Bulb/2/Confirm')
  //client.publish('pinghome_siri', 'Example Light is Ready !')
})
...
var LightController = {
  name: "Ligth_2", //name of accessory
  pincode: "031-45-154",
  ...
  setPower: function(status) { //set power of accessory
    ...
    this.power = status;
    if(status){
    //client.publish('c_light_acc', 'light example on!')
    client.publish('Thing_Bulb/2/Order', 'Bulb/2/true')
    console.log("send Bulb 2 from siri")
    }
    else{
    //client.publish('c_light_acc', 'light example off!')
    client.publish('Thing_Bulb/2/Order', 'Bulb/2/false')
    console.log("send Bulb 2 from siri")
    }
  },
  ...
  setBrightness: function(brightness) { //set brightness
    ...
    //client.publish('c_light_acc', 'Set Bightness to '+brightness)
